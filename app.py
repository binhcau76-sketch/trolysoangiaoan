...
<div class="main-header">
    ...
    <p>Tác giả: Cẩu Thị Bình - Trường PTDTBT Tiểu học Sủng Thài - ĐT: 033 3087 184</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Cẩu Thị Bình - Trường PTDTBT Tiểu học Sủng Thài - ĐT: 033 3087 184</div>", unsafe_allow_html=True)
